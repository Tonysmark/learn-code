...
function Identify() {
    ...
    if (final.facts[final.facts.length - 1] == '长颈鹿' ||
        ...
        var str = "<p style='padding: 5px;width: 300px;margin:0 auto;text-align:center;'class='alert-primary'>你所描述的动物是" 
        + final.facts[final.facts.length - 1] + "。</p>";
        $('#conclusion')
        .html(str)
        .append('<img class="img" style="width:300px;height:300px" src="img/' 
        + final.facts[final.facts.length - 1] + '.jpg">');
